...
def lambda_function_check_setup(lambda_function_name: str, region: str,
                                lamba_timeout: int):
...
def lambda_function_setup_contain_env_var(lambda_function_name: str, region: str,
                                env_var:str):
    lambda_configuration = get_lambda_configuration(lambda_function_name, region)
    assert env_var in lambda_configuration["Environment"]["Variables"]


def lambda_function_check_env_var_value(lambda_function_name: str, region: str,
