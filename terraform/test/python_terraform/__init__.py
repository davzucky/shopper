...
# Source code copy from https://github.com/beelit94/python-terraform
# until terraform 0.12 is supported
...
class Terraform(object):
    ...
    def generate_cmd_string(self, cmd, *args, **kwargs):
        ...
        --> python call:
        tf.generate_cmd_string('apply', the_folder, /
        no_color=IsFlagged, var={'a':'b', 'c':'d'})
    ...
    def cmd(self, cmd, *args, **kwargs):
        ...
        :param kwargs:  any option flag with key value without prefixed dash character
                ...
                if the option 'raise_on_error' is passed (with any value /
                that evaluates to True),
                    and the terraform command returns a nonzerop return code, then
                    a TerraformCommandError exception will be raised. The /
    ...
    def output(self, *args, **kwargs):
        ...
        convention. To use the "output" command with the standard
        convention, call "output_cmd" instead of
        "output".
